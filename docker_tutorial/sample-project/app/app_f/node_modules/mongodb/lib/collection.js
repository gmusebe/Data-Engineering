...
const removeDocuments = require('mongodb/lib/operations/common_functions').removeDocuments;
const save = require('mongodb/lib/operations/collection_ops').save;
const updateDocuments = require('mongodb/lib/operations/common_functions').updateDocuments;

const AggregateOperation = require('mongodb/lib/operations/aggregate');
const BulkWriteOperation = require('mongodb/lib/operations/bulk_write');
const CountDocumentsOperation = require('mongodb/lib/operations/count_documents');
const CreateIndexOperation = require('mongodb/lib/operations/create_index');
const CreateIndexesOperation = require('mongodb/lib/operations/create_indexes');
const DeleteManyOperation = require('mongodb/lib/operations/delete_many');
const DeleteOneOperation = require('mongodb/lib/operations/delete_one');
const DistinctOperation = require('mongodb/lib/operations/distinct');
const DropCollectionOperation = require('mongodb/lib/operations/drop').DropCollectionOperation;
const DropIndexOperation = require('mongodb/lib/operations/drop_index');
const DropIndexesOperation = require('mongodb/lib/operations/drop_indexes');
const EstimatedDocumentCountOperation = require('mongodb/lib/operations/estimated_document_count');
const FindOperation = require('mongodb/lib/operations/find');
const FindOneOperation = require('mongodb/lib/operations/find_one');
const FindAndModifyOperation = require('mongodb/lib/operations/find_and_modify');
const FindOneAndDeleteOperation = require('mongodb/lib/operations/find_one_and_delete');
const FindOneAndReplaceOperation = require('mongodb/lib/operations/find_one_and_replace');
const FindOneAndUpdateOperation = require('mongodb/lib/operations/find_one_and_update');
const GeoHaystackSearchOperation = require('mongodb/lib/operations/geo_haystack_search');
const IndexesOperation = require('mongodb/lib/operations/indexes');
const IndexExistsOperation = require('mongodb/lib/operations/index_exists');
const IndexInformationOperation = require('mongodb/lib/operations/index_information');
const InsertManyOperation = require('mongodb/lib/operations/insert_many');
const InsertOneOperation = require('mongodb/lib/operations/insert_one');
const IsCappedOperation = require('mongodb/lib/operations/is_capped');
const ListIndexesOperation = require('mongodb/lib/operations/list_indexes');
const MapReduceOperation = require('mongodb/lib/operations/map_reduce');
const OptionsOperation = require('mongodb/lib/operations/options_operation');
const RenameOperation = require('mongodb/lib/operations/rename');
const ReIndexOperation = require('mongodb/lib/operations/re_index');
const ReplaceOneOperation = require('mongodb/lib/operations/replace_one');
const StatsOperation = require('mongodb/lib/operations/stats');
const UpdateManyOperation = require('mongodb/lib/operations/update_many');
const UpdateOneOperation = require('mongodb/lib/operations/update_one');
